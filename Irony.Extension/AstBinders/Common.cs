...
namespace Irony.Extension.AstBinders
{
    ...
    {
        public static AstNodeWrapper<T> Create<T>(T astObject, AstContext context, ParseTreeNode treeNode)
        {
    ...
    public class AstNodeWrapper<T> : IBrowsableAstNode
    {
        ...
        public AstNodeWrapper(T astObject, AstContext context, ParseTreeNode treeNode)
        {
