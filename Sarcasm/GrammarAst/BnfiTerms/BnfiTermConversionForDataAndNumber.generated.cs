...
namespace Sarcasm.GrammarAst
{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversionTL CreateDataLiteral(string name = "dataliteral")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.Object).IntroDataLiteral();
		}

        public static BnfiTermConversionTL CreateDataLiteralDsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Object).IntroDataLiteral();
		}

        public static BnfiTermConversionTL CreateDataLiteralDsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Object, terminator: terminator).IntroDataLiteral();
		}

        public static BnfiTermConversionTL CreateDataLiteralQuoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.Object, startEndSymbol: startEndSymbol).IntroDataLiteral();
		}

        public static BnfiTermConversionTL CreateDataLiteralQuoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversionTL CreateDataLiteralFixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<DBNull> CreateDataLiteralDBNull(string name = "dataliteralDBNull")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.DBNull).IntroDataLiteralDBNull();
		}

        public static BnfiTermConversion<DBNull> CreateDataLiteralDBNullDsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.DBNull).IntroDataLiteralDBNull();
		}

        public static BnfiTermConversion<DBNull> CreateDataLiteralDBNullDsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.DBNull, terminator: terminator).IntroDataLiteralDBNull();
		}

        public static BnfiTermConversion<DBNull> CreateDataLiteralDBNullQuoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.DBNull, startEndSymbol: startEndSymbol).IntroDataLiteralDBNull();
		}

        public static BnfiTermConversion<DBNull> CreateDataLiteralDBNullQuoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<DBNull> CreateDataLiteralDBNullFixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<Boolean> CreateDataLiteralBoolean(string name = "dataliteralBoolean")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.Boolean).IntroDataLiteralBoolean();
		}

        public static BnfiTermConversion<Boolean> CreateDataLiteralBooleanDsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Boolean).IntroDataLiteralBoolean();
		}

        public static BnfiTermConversion<Boolean> CreateDataLiteralBooleanDsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Boolean, terminator: terminator).IntroDataLiteralBoolean();
		}

        public static BnfiTermConversion<Boolean> CreateDataLiteralBooleanQuoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.Boolean, startEndSymbol: startEndSymbol).IntroDataLiteralBoolean();
		}

        public static BnfiTermConversion<Boolean> CreateDataLiteralBooleanQuoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<Boolean> CreateDataLiteralBooleanFixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<Char> CreateDataLiteralChar(string name = "dataliteralChar")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.Char).IntroDataLiteralChar();
		}

        public static BnfiTermConversion<Char> CreateDataLiteralCharDsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Char).IntroDataLiteralChar();
		}

        public static BnfiTermConversion<Char> CreateDataLiteralCharDsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Char, terminator: terminator).IntroDataLiteralChar();
		}

        public static BnfiTermConversion<Char> CreateDataLiteralCharQuoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.Char, startEndSymbol: startEndSymbol).IntroDataLiteralChar();
		}

        public static BnfiTermConversion<Char> CreateDataLiteralCharQuoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<Char> CreateDataLiteralCharFixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<SByte> CreateDataLiteralSByte(string name = "dataliteralSByte")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.SByte).IntroDataLiteralSByte();
		}

        public static BnfiTermConversion<SByte> CreateDataLiteralSByteDsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.SByte).IntroDataLiteralSByte();
		}

        public static BnfiTermConversion<SByte> CreateDataLiteralSByteDsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.SByte, terminator: terminator).IntroDataLiteralSByte();
		}

        public static BnfiTermConversion<SByte> CreateDataLiteralSByteQuoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.SByte, startEndSymbol: startEndSymbol).IntroDataLiteralSByte();
		}

        public static BnfiTermConversion<SByte> CreateDataLiteralSByteQuoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<SByte> CreateDataLiteralSByteFixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<Byte> CreateDataLiteralByte(string name = "dataliteralByte")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.Byte).IntroDataLiteralByte();
		}

        public static BnfiTermConversion<Byte> CreateDataLiteralByteDsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Byte).IntroDataLiteralByte();
		}

        public static BnfiTermConversion<Byte> CreateDataLiteralByteDsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Byte, terminator: terminator).IntroDataLiteralByte();
		}

        public static BnfiTermConversion<Byte> CreateDataLiteralByteQuoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.Byte, startEndSymbol: startEndSymbol).IntroDataLiteralByte();
		}

        public static BnfiTermConversion<Byte> CreateDataLiteralByteQuoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<Byte> CreateDataLiteralByteFixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<Int16> CreateDataLiteralInt16(string name = "dataliteralInt16")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.Int16).IntroDataLiteralInt16();
		}

        public static BnfiTermConversion<Int16> CreateDataLiteralInt16Dsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Int16).IntroDataLiteralInt16();
		}

        public static BnfiTermConversion<Int16> CreateDataLiteralInt16Dsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Int16, terminator: terminator).IntroDataLiteralInt16();
		}

        public static BnfiTermConversion<Int16> CreateDataLiteralInt16Quoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.Int16, startEndSymbol: startEndSymbol).IntroDataLiteralInt16();
		}

        public static BnfiTermConversion<Int16> CreateDataLiteralInt16Quoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<Int16> CreateDataLiteralInt16FixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<UInt16> CreateDataLiteralUInt16(string name = "dataliteralUInt16")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.UInt16).IntroDataLiteralUInt16();
		}

        public static BnfiTermConversion<UInt16> CreateDataLiteralUInt16Dsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.UInt16).IntroDataLiteralUInt16();
		}

        public static BnfiTermConversion<UInt16> CreateDataLiteralUInt16Dsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.UInt16, terminator: terminator).IntroDataLiteralUInt16();
		}

        public static BnfiTermConversion<UInt16> CreateDataLiteralUInt16Quoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.UInt16, startEndSymbol: startEndSymbol).IntroDataLiteralUInt16();
		}

        public static BnfiTermConversion<UInt16> CreateDataLiteralUInt16Quoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<UInt16> CreateDataLiteralUInt16FixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<Int32> CreateDataLiteralInt32(string name = "dataliteralInt32")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.Int32).IntroDataLiteralInt32();
		}

        public static BnfiTermConversion<Int32> CreateDataLiteralInt32Dsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Int32).IntroDataLiteralInt32();
		}

        public static BnfiTermConversion<Int32> CreateDataLiteralInt32Dsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Int32, terminator: terminator).IntroDataLiteralInt32();
		}

        public static BnfiTermConversion<Int32> CreateDataLiteralInt32Quoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.Int32, startEndSymbol: startEndSymbol).IntroDataLiteralInt32();
		}

        public static BnfiTermConversion<Int32> CreateDataLiteralInt32Quoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<Int32> CreateDataLiteralInt32FixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<UInt32> CreateDataLiteralUInt32(string name = "dataliteralUInt32")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.UInt32).IntroDataLiteralUInt32();
		}

        public static BnfiTermConversion<UInt32> CreateDataLiteralUInt32Dsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.UInt32).IntroDataLiteralUInt32();
		}

        public static BnfiTermConversion<UInt32> CreateDataLiteralUInt32Dsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.UInt32, terminator: terminator).IntroDataLiteralUInt32();
		}

        public static BnfiTermConversion<UInt32> CreateDataLiteralUInt32Quoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.UInt32, startEndSymbol: startEndSymbol).IntroDataLiteralUInt32();
		}

        public static BnfiTermConversion<UInt32> CreateDataLiteralUInt32Quoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<UInt32> CreateDataLiteralUInt32FixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<Int64> CreateDataLiteralInt64(string name = "dataliteralInt64")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.Int64).IntroDataLiteralInt64();
		}

        public static BnfiTermConversion<Int64> CreateDataLiteralInt64Dsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Int64).IntroDataLiteralInt64();
		}

        public static BnfiTermConversion<Int64> CreateDataLiteralInt64Dsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Int64, terminator: terminator).IntroDataLiteralInt64();
		}

        public static BnfiTermConversion<Int64> CreateDataLiteralInt64Quoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.Int64, startEndSymbol: startEndSymbol).IntroDataLiteralInt64();
		}

        public static BnfiTermConversion<Int64> CreateDataLiteralInt64Quoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<Int64> CreateDataLiteralInt64FixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<UInt64> CreateDataLiteralUInt64(string name = "dataliteralUInt64")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.UInt64).IntroDataLiteralUInt64();
		}

        public static BnfiTermConversion<UInt64> CreateDataLiteralUInt64Dsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.UInt64).IntroDataLiteralUInt64();
		}

        public static BnfiTermConversion<UInt64> CreateDataLiteralUInt64Dsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.UInt64, terminator: terminator).IntroDataLiteralUInt64();
		}

        public static BnfiTermConversion<UInt64> CreateDataLiteralUInt64Quoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.UInt64, startEndSymbol: startEndSymbol).IntroDataLiteralUInt64();
		}

        public static BnfiTermConversion<UInt64> CreateDataLiteralUInt64Quoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<UInt64> CreateDataLiteralUInt64FixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<Single> CreateDataLiteralSingle(string name = "dataliteralSingle")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.Single).IntroDataLiteralSingle();
		}

        public static BnfiTermConversion<Single> CreateDataLiteralSingleDsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Single).IntroDataLiteralSingle();
		}

        public static BnfiTermConversion<Single> CreateDataLiteralSingleDsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Single, terminator: terminator).IntroDataLiteralSingle();
		}

        public static BnfiTermConversion<Single> CreateDataLiteralSingleQuoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.Single, startEndSymbol: startEndSymbol).IntroDataLiteralSingle();
		}

        public static BnfiTermConversion<Single> CreateDataLiteralSingleQuoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<Single> CreateDataLiteralSingleFixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<Double> CreateDataLiteralDouble(string name = "dataliteralDouble")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.Double).IntroDataLiteralDouble();
		}

        public static BnfiTermConversion<Double> CreateDataLiteralDoubleDsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Double).IntroDataLiteralDouble();
		}

        public static BnfiTermConversion<Double> CreateDataLiteralDoubleDsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Double, terminator: terminator).IntroDataLiteralDouble();
		}

        public static BnfiTermConversion<Double> CreateDataLiteralDoubleQuoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.Double, startEndSymbol: startEndSymbol).IntroDataLiteralDouble();
		}

        public static BnfiTermConversion<Double> CreateDataLiteralDoubleQuoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<Double> CreateDataLiteralDoubleFixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<Decimal> CreateDataLiteralDecimal(string name = "dataliteralDecimal")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.Decimal).IntroDataLiteralDecimal();
		}

        public static BnfiTermConversion<Decimal> CreateDataLiteralDecimalDsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Decimal).IntroDataLiteralDecimal();
		}

        public static BnfiTermConversion<Decimal> CreateDataLiteralDecimalDsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.Decimal, terminator: terminator).IntroDataLiteralDecimal();
		}

        public static BnfiTermConversion<Decimal> CreateDataLiteralDecimalQuoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.Decimal, startEndSymbol: startEndSymbol).IntroDataLiteralDecimal();
		}

        public static BnfiTermConversion<Decimal> CreateDataLiteralDecimalQuoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<Decimal> CreateDataLiteralDecimalFixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<DateTime> CreateDataLiteralDateTime(string name = "dataliteralDateTime")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.DateTime).IntroDataLiteralDateTime();
		}

        public static BnfiTermConversion<DateTime> CreateDataLiteralDateTimeDsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.DateTime).IntroDataLiteralDateTime();
		}

        public static BnfiTermConversion<DateTime> CreateDataLiteralDateTimeDsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.DateTime, terminator: terminator).IntroDataLiteralDateTime();
		}

        public static BnfiTermConversion<DateTime> CreateDataLiteralDateTimeQuoted(string name, string startEndSymbol)
		{
        ...
        public static BnfiTermConversion<DateTime> CreateDataLiteralDateTimeQuoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<DateTime> CreateDataLiteralDateTimeFixedLength(string name, int length)
		{
    ...
    public partial class TerminalFactoryS
	{
        ...
        public static BnfiTermConversion<String> CreateDataLiteralString(string name = "dataliteralString")
		{
			return new DataLiteralBase(name: name, dataType: TypeCode.String).IntroDataLiteralString();
		}

        public static BnfiTermConversion<String> CreateDataLiteralStringDsv(string name)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.String).IntroDataLiteralString();
		}

        public static BnfiTermConversion<String> CreateDataLiteralStringDsv(string name, string terminator)
		{
			return new DsvLiteral(name: name, dataType: TypeCode.String, terminator: terminator).IntroDataLiteralString();
		}

        public static BnfiTermConversion<String> CreateDataLiteralStringQuoted(string name, string startEndSymbol)
		{
			return new QuotedValueLiteral(name: name, dataType: TypeCode.String, startEndSymbol: startEndSymbol).IntroDataLiteralString();
		}

        public static BnfiTermConversion<String> CreateDataLiteralStringQuoted(string name, string startSymbol, string endSymbol)
		{
        ...
        public static BnfiTermConversion<String> CreateDataLiteralStringFixedLength(string name, int length)
		{
